 ...
 */
public class TestPlusOne extends Thread {
    ...
    static {
        try {
            ...
            casOffset = UNSAFE.staticFieldOffset(TestPlusOne.class.getDeclaredField("cas"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void cas(){
        ...
        while(!bl){
            tmp = cas;
            bl = UNSAFE.compareAndSwapInt(TestPlusOne.class, casOffset, tmp,tmp+1);
        }
    }
