package hemi.xmu.dataStructure;
...
class Random31 {
	...
	// Test program
	/*
	 * public static void main( String [ ] args ) { Random31 r = new Random31(
	 * );
	 * 
	 ...
	 * 
	 * final int SAMPLES = 100000000; for( int i = 0; i < SAMPLES; i++ ) dist[
	 * r.nextPoisson( 2 ) ]++; for( int i = 0; i < 10; i++ ) System.out.println(
...
class Random48 {
	...
	// Test program
	/*
	 * public static void main( String [ ] args ) { Random48 r = new Random48(
	 * );
	 * 
	 * for( int i = 0; i < 20; i++ ) System.out.println( r.nextInt( ) );
	 * 
