...
/**
 * Stack class. Unlike java.util.Stack, this is not extended from Vector. This
 * is the minimum respectable set of operations.
 */
public class Stack<AnyType> implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2097123368234213260L;
