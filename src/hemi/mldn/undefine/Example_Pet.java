...
public class Example_Pet {
	public static void main(String args[]){
		...
		ps.add(new Cat("°×Ã¨","°×É«",2));
		ps.add(new Cat("ºÚÃ¨","°×É«",4));
		ps.add(new Cat("ºÚ»¯Ã¨","»ÒÉ«",3));
		ps.add(new Cat("°×Ã¨","ÂÌÉ«",3));
		ps.add(new Cat("Ã¨","ÂÌÉ«",3));
		ps.search("ºÚ");
	}
}
...
class PetShop {
	...
	public boolean add(Pet pet) {
		if (this.index < this.pets.length) {
			...
			System.out.println( "index out¡£´ËÌõÊ§°Ü£º[name=" + pet.getName() + ", color=" + pet.getColor() + ", age=" + pet.getAge() + "]");
			return false;
		}
	}
